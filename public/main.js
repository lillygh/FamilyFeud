...
function setTurn(){
	...
	if(r==1){
		...
		turn = player3Name;
		gameMsg(player3Name + " goes first. You have 1 minute and 3 chances to answer the following question...");
...
$(".answerInputButton").click(function(){
	...
	// if strikeCount === 3, switch players
})
